...
def extract_row23_point_cloud(dataset_sub, dataset_sub_NG, DEM_x, DEM_y, DEM_z, plot_grid_row23, LEFT_X, TOP_Y, res_extract):
    ...
    num_plots = len( pd.unique(plot_grid_row23['plot_ID'])/2 )
...
############################ Change this part 
        tupVerts=[(plot_grid_row23['x0'][j*2],plot_grid_row23['y0'][j*2]),     # (1)
                  ...
                  (plot_grid_row23['x0'][j*2+1],plot_grid_row23['y0'][j*2+1]), # (3)
                  (plot_grid_row23['x1'][j*2+1],plot_grid_row23['y0'][j*2+1]), # (4)
                  (plot_grid_row23['x1'][j*2+1],plot_grid_row23['y1'][j*2+1]), # (5)
                  (plot_grid_row23['x0'][j*2+1],plot_grid_row23['y1'][j*2+1]), # (6)
                  (plot_grid_row23['x1'][j*2],plot_grid_row23['y1'][j*2]),     # (7)
                  (plot_grid_row23['x0'][j*2],plot_grid_row23['y1'][j*2])]     # (8)
...
def main(args):
    ...
    if user_input == 'n':
        ...
        for j in range(int(len(PLOT_ID)/2)):
            #print(j)
            #print(range(len(PLOT_ID)-1))
            #print(plot_grid_row23)
            tupVerts=[(plot_grid_row23['x0'][j*2],plot_grid_row23['y0'][j*2]),     # (1)
                      (plot_grid_row23['x1'][j*2],plot_grid_row23['y0'][j*2]),     # (2)
                      (plot_grid_row23['x0'][j*2+1],plot_grid_row23['y0'][j*2+1]), # (3)
                      (plot_grid_row23['x1'][j*2+1],plot_grid_row23['y0'][j*2+1]), # (4)
            ...
            NG_lidar_avgH[a,b,1] = plot_grid_row23['plot_ID'][j*2]
                                    ...
                                    np.hstack((all_f['int_percent_features'], 
                                        np.hstack((all_f['plots_LII'], 
                                            np.hstack((all_f['height_stat_features'],
                                                np.hstack((all_f['int_stat_features'],all_f['plots_vol'])) )) )) )) )) )) ))
