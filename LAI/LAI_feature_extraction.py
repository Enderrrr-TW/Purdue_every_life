'''
This code is the python version of Behrokh's feature extraction code (originally in matlab).
Most variables' names are not changed
This script extracts features from LiDAR point cloud for estimating LAI via support vector regression
'''
import laspy
import numpy as np
import os
