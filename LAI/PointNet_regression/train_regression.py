...
def parse_args():
    ...
    parser.add_argument('--num_category', default=1, type=int, choices=[1],  help='training on ModelNet10/40')
...
def main(args):
    ...
    train_dataset = LASDataLoader(root=data_path, split='train', preprocessed=True)
